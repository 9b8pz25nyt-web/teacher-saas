    ...
    <div className="space-y-4 printable-journal-area">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-pink-100 pb-3">
        ...
        <div className="flex items-center gap-2">
          <span className="text-[10px] font-bold text-emerald-700 bg-emerald-50 px-2.5 py-1 rounded-lg border border-emerald-200 uppercase mr-2 hidden md:inline-block">
                    ...
                    return (
                      <tr key={entry.id} className="hover:bg-pink-50/20 transition">
                        ...
                        <td className="p-3.5 space-y-1 align-top">
                          ...
                          {entry.feePhp > 0 && (
                            <div className="pl-4 text-rose-600 font-medium italic">
